<?php
//fetch.php
$connect = mysqli_connect("localhost", "root", "hal123din", "spdb");
...
{
 $sub_array = array();
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id_trx_detail"].'" data-column="petani">' . $row["petani"] . '</div>';
