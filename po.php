                           ...
                           echo " <td>$nama[username]</td>
                            ...
                            <td>
                              <div class='hidden-sm hidden-xs action-buttons'>
                                ...
                                <a class='green' href='?halamane=po&act=editpo&id=$r[id_po]'>
                                  <i class='ace-icon fa fa-pencil bigger-130'></i>
                                </a>

                                <a class='red' href='$aksi?halamane=po&act=hapus&id=$r[id_po]'>
                              ...
                              <div class='hidden-md hidden-lg'>
                                <div class='inline pos-rel'>
                                  ...
                                  <ul class='dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close'>
                                    ...
                                    <li>
                                      <a href='?halamane=po&act=editpo&id=$r[id_po]' class='tooltip-success' data-rel='tooltip' title='Edit'>
                                        <span class='green'>
                                    ...
                                    <li>
                                      <a href='$aksi?halamane=po&act=hapus&id=$r[id_po]' class='tooltip-error' data-rel='tooltip' title='Delete'>
                                        <span class='red'>
