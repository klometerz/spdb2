     ...
     echo" <div class='row'>
                  <div class='col-xs-12'>
                    ...
                    <div class='clearfix'>
                      ...
                      <button class='btn btn-white btn-info btn-bold' onclick=window.location.href=\"?halamane=perbaikan&act=tambahperbaikan\"><i class='ace-icon glyphicon glyphicon-plus'></i>
