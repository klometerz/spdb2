    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                 Data Stok Pengepul : <font color="#FF0004"><?php echo $petani['nama_petani']; echo " - "; echo $petani['desa_petani']; ?></font><br /> Kode : <font color="#FF0004"><?php echo substr($petani['kode_petani'], 0, 2); echo"-";  echo $sup['tgl_trx'];?></font>
				 <br /> Tanggal : <font color="#FF0004"><?php echo $sup['tgl_trx']; ?></font>
