...
<div class='row'>
    <div class='col-xs-12'>
                      <div class='widget-box'>
                        <div class='widget-header'>
                          <h4 class='widget-title'>Lembar Produksi CPU</h4>
                        ...
                        <div class='widget-body'>
                          ...
                          <form method="POST" action="?halamane=trans_cpu">
  ...
  <div>
							...
							while($crop=mysqli_fetch_array($tampil_crop))
							{
                              ...
                              <hr /> 
							  <label>Qty Produksi (KG)</label>
                              <input required="required" type="text" name="qty" class='form-control'  placeholder=''  value='' >
							   <hr /> 
							  <label>Remarks</label>
                              <input required="required" type="text" name="remarks" class='form-control'  placeholder=''  value='' >
