...
?>
								...
								<form width="550" height="170" target="_blank" rel="noopener noreferrer" action="site.php?halamane=trx_p_detail&kd=<?php echo $_GET['id_trx']; ?>&prm=<?php echo $_GET['uniqid_trx_p2']; ?>" method="POST">
