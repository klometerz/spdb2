     ...
     echo" <div class='row'>
                  <div class='col-xs-12'>
                    ...
                    <div class='clearfix'>
                      ...
                      <button class='btn btn-white btn-info btn-bold' onclick=window.location.href=\"?halamane=input_transaksi_farm\"><i class='ace-icon glyphicon glyphicon-plus'></i>
                        Pembelian Baru</button>
                    </div>
                    <br/>
                    <div class='table-header'>
                      Pembelian Barang Petani
                    </div>
                    <div>";

        if ($_SESSION['level']=='1'){
        $query  = "select * from tb_trx_p_petani where status = '1'";
      ...
      while ($r=mysqli_fetch_array($tampil)){
	   ...
	   echo "
                          <tr>
                            ...
                            <td><a class='green' href='?halamane=trx_p&id=$r[id_trx]'> $r[tgl_trx]</a></td>
