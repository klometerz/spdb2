     ...
     echo" <div class='row'>
                  <div class='col-xs-12'>
                    ...
                    <div class='clearfix'>
                      ...
                      <button class='btn btn-white btn-info btn-bold' onclick=window.location.href=\"?halamane=input_transaksi_cpu\"><i class='ace-icon glyphicon glyphicon-plus'></i>
                        Produksi Stok Baru</button>
                    </div>
                    <br/>
        ...
        if ($_SESSION['level']=='1'){
        $query  = "select * from tb_trx_p_petani where status ='4'";
...
//echo $peng['pengepul'];
	   ...
	   echo "
                          <tr>
                            ...
                            <td><a class='green' href='?halamane=trx_cpu2&id=$r[id_trx]'> $r[tgl_trx] - $peng[pengepul]</a></td>
                           ...
                           <td class='hidden-480'>$r[date_create]</td>
							...
							elseif ($r['status'] == '4')
							{
								echo '<i color="green">Ready To Deliver</i>';
							}
							elseif ($r['status'] == '5')
							{
							...
							echo "
                                ...
                                <a class='red' href='$aksi?halamane=del_cpu&act=cancel&id=$r[id_trx]'>
