    ...
    <div class='col-xs-12'>
                      <div class='widget-box'>
                        <div class='widget-header'>
                          <h4 class='widget-title'>Form Input Detail PO</h4>
                        ...
                        <div class='widget-body'>
                          ...
                          <form method="POST" action="halaman/hal_purchasing/aksi_po_detail.php?halamane=input_detail_po">
			...
			$data_po = mysqli_fetch_array($tampil_po);
							  ?>
							   <input  type="hidden" name="no_po" class='form-control' placeholder=''  value='<?php echo $data_po['no_po']; ?>' >
							     <input  type="hidden" name="nama_supplier" class='form-control' placeholder=''  value='<?php echo $_SESSION['auth_code']; ?>' >
								  <input  type="hidden" name="nama_customer" class='form-control' placeholder=''  value='<?php echo "FARM-PO003"; ?>' >
