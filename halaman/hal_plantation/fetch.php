...
$id_trans=$_GET['id'];
$query = "SELECT * FROM tb_trx_p_plantation_detail where id_trx='".$id_trans."' ";
...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id_trx_detail"].'" data-column="total_qty2">' . $row["total_qty2"] . '</div>';
...
// want to add something new about gopay
