...
// Apabila user sudah login dengan benar, maka terbentuklah session
  ...
  $aksi = "halaman/hal_plantation/aksi_plantation.php";
     ...
     echo" <div class='row'>
                  <div class='col-xs-12'>
                    ...
                    <div class='clearfix'>
                      ...
                      <button class='btn btn-white btn-info btn-bold' onclick=window.location.href=\"?halamane=input_transaksi_plantation\"><i class='ace-icon glyphicon glyphicon-plus'></i>
                        Pengumpulan Baru</button>
                    </div>
                    <br/>
        ...
        if ($_SESSION['level']=='1'){
        $query  = "select * from tb_trx_p_plantation where status = '1'";
        $tampil = mysqli_query($konek, $query);
      } else{
		  $status = $_SESSION['auth_code'];
        $query  = "SELECT * FROM tb_trx_p_plantation where pengepul = '$status' ";
        $tampil = mysqli_query($konek, $query);
      }
      ...
      while ($r=mysqli_fetch_array($tampil)){
	   ...
	   echo "
                          <tr>
                            ...
                            <td><a class='green' href='?halamane=trx_plantation&id=$r[id_trx]'> $r[tgl_trx]</a></td>
                           ...
                           <td class='hidden-480'>$r[date_create]</td>
                            ...
                            <td>
                              <div class='hidden-sm hidden-xs action-buttons'>
                                ...
                                <a class='red' href='$aksi?halamane=del&act=cancel&id=$r[id_trx]'>
 ...
 ";
							...
							echo "
                                  <ul class='dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close'>
                                    ...
                                    <li>
                                      <a href='$aksi?halamane=del&act=cancel&id=$r[id_trx]' class='tooltip-error' data-rel='tooltip' title='Delete'>
                                        <span class='red'>
