...
// Apabila user sudah login dengan benar, maka terbentuklah session
  ...
  elseif ($halamane=='del' AND $act=='cancel'){
      mysqli_query($konek, "DELETE FROM tb_trx_p_petani WHERE id_trx='$_GET[id]'"); 
       header("location:../../site.php?halamane=transaksi_farm");
  }
   elseif ($halamane=='del_cpu' AND $act=='cancel'){
      mysqli_query($konek, "DELETE FROM tb_trx_p_petani WHERE id_trx='$_GET[id]'"); 
       header("location:../../site.php?halamane=transaksi_cpu");
  }
  elseif ($halamane=='del_peng' AND $act=='cancel'){
      mysqli_query($konek, "DELETE FROM tb_trx_p_petani WHERE id_trx='$_GET[id]'"); 
       header("location:../../site.php?halamane=transaksi_p2");
  }
}
?>
