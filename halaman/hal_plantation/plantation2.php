...
<script src="https://code.jquery.com/jquery-1.12.4.js"></script>
  ...
  $id_trans=$_GET['id'];
  // data trx petani
$query_sup  = "select * from tb_trx_p_plantation where id_trx ='$id_trans'";
 ...
 $(document).ready(function(){
  ...
  function fetch_data()
  {
   var dataTable = $('#user_data').DataTable({
    ...
    "order" : [],
    "ajax" : {
     url:"halaman/hal_plantation/fetch.php?id=<?php echo $id_trans; ?>",
     type:"POST"
    }
   });
  }
  ...
  $(document).on('click', '#insert', function(){
   ...
   {
    $.ajax({
     url:"halaman/hal_plantation/insert.php?id=<?php echo $id_trans; ?>",
     method:"POST",
